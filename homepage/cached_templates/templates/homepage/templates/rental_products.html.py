...
_magic_number = 10
_modified_time = 1427848870.259699
_enable_loop = True
...
def render_content(context, **pageargs):
    ...
    try:
        ...
        for product in products:
            ...
            __M_writer(str(product.id))
            __M_writer(
                '" class="add_to_cart_btn btn btn-warning btn-xs">Add to Cart</button>\n                </div>\n            </div>\n')
        __M_writer('    </div>  <!--search_results-->\n</div>  <!--search_results_container-->\n\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"uri": "/homepage/templates/rental_products.html", "line_map": {"64": 24, "65": 27, "66": 27, "27": 0, "36": 1, "73": 67, "46": 3, "67": 31, "54": 3, "55": 20, "56": 21, "57": 22, "58": 22, "59": 23, "60": 23, "61": 23, "62": 23, "63": 24}, "filename": "/Users/Nate/chf_dmp/homepage/templates/rental_products.html", "source_encoding": "ascii"}
__M_END_METADATA
"""
